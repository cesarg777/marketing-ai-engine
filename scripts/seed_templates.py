...
DEFAULT_TEMPLATES = [
    {
        ...
        "description": "Multi-slide educational carousel for LinkedIn/Instagram. 5-10 slides with hook, key points, and CTA.",
        "structure": [
        ...
        "system_prompt": "Create an educational carousel that hooks the reader on slide 1, delivers value on slides 2-8, and ends with a strong CTA. Each slide should be self-contained but flow as a narrative. Use short punchy sentences. Include visual prompts for each slide that would work for image generation.",
    ...
    },
    {
        ...
        "description": "Team member spotlight post. Humanizes the brand by showcasing team members.",
        "structure": [
        ...
        "system_prompt": "Create a warm, authentic team spotlight. The quote should feel genuine and relatable. The bio should mix professional achievements with personality. The fun fact should be memorable.",
        "default_tone": "warm",
    },
    {
        "name": "Case Study",
        ...
        "description": "Client success story with challenge/solution/results framework.",
        "structure": [
        ...
        "system_prompt": "Create a compelling case study that follows the Challenge → Solution → Results framework. Lead with the most impressive result. Use specific numbers. The testimonial should feel authentic.",
        "default_tone": "professional",
    },
    {
        "name": "Meme",
        "slug": "meme",
        "content_type": "meme",
        "description": "B2B-relevant meme for social media. Relatable humor that drives engagement.",
        "structure": [
        ...
        "system_prompt": "Create a B2B meme that's genuinely funny and relatable to professionals in the target niche. Avoid cringe or forced humor. The best B2B memes capture a universal frustration or inside joke that makes people tag their colleagues.",
    ...
    },
    {
        ...
        "description": "Script for AI avatar video. Time-coded sections with speaking directions.",
        "structure": [
            {"name": "title", "type": "text", "required": True, "max_length": 80},
        ...
        "system_prompt": "Write a conversational video script that sounds natural when spoken aloud (not written). Use short sentences. Vary the pacing — start strong, build tension, deliver the insight, end with action. Each section should be 15-30 seconds. Include emotion and gesture cues.",
